...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "CRAZY;;;jBIBQLZb#WQWAi-Sye-WFNybXSHW-AwHLIhTvcG8f4yzNFeMuMNs",
...
MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/jma6os.jpeg",
// add custom menu and mention reply image url
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "JUNIOR-MD",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "JUNIOR-MD💫",
...
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/jma6os.jpg",
